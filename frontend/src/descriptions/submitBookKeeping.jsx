export const submitBookKeeping =
    ...
    "Ex: Säg att FooIT18/19 vill lämna in sin bokföring inför sektionsmötet LP1, då skickar kassören ett mail med ämnesraden  \n" +
    "`FooIT Sektionsmöte LP1 bokföring`  \n" +
    "Ex: FooIT18/19 vill i LP2 lämna in sin bokföring för att bli ansvarsbefriade, då skickar kassören ett mail med ämnesraden  \n" +
    "`FooIT18/19 ansvarsbefrielse LP2`  \n" +
    ...
    "Om du skulle behöva skicka flera filer under samma kategori så lägger du till ett index i slutet på namnet.\n" +
    ...
    "Då kommer de heta `barit19_lp1_huvudbok_0.pdf` och `barit19_lp1_huvudbok_0.pdf` i LP1.\n" +
